...
var pinkb=createGroup()
var blueb=createGroup()
var arrows=createGroup()
function preload(){
...
function draw() {
 background(0);
  ...
  redb=addSprite(redBalloon)
  blueb=addSprite(blueBalloon)
  pinkb=addSprite(pinkBalloon)
  greenb=addSprite(greenBalloon)
}
